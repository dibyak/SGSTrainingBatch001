...
//adding arguments in above function
function f1(something,str1,str2) {
    console.log(something,str1,str2);
}
function f2(num1,num2, myCallback, str1,str2 ) {
    let result = num1* num2;
    myCallback(result, str1,str2 );
}
f2(5,5, f1,"abc", "xyz");
